...
macro(xpackage_download url localfile hashtype)
	...
	if(NOT EXISTS ${status_file_})
		...
		file(DOWNLOAD ${url} ${localfile} STATUS result_ EXPECTED_HASH ${hashtype})
...
macro(xpackage_export )	
	...
	if(DEFINED XPACKAGE_EXPORT_FLAGS)
		set(export_info_ "${export_info_}add_compile_options(${XPACKAGE_EXPORT_FLAGS})\n")	
	endif()
...
#使用给定的变量初始化包
macro(xpackage_init)
	message("-- Setup Package: ${XPACKAGE_NAME} ${XPACKAGE_VERSION}")
	#按URL获取保存文件名
