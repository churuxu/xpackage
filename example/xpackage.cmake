...
set(XPACKAGE_ROOT ${CMAKE_CURRENT_LIST_DIR})

#depends
macro(xpackage_depends target package)	
	if(TARGET ${package})		
		#add_subdirectory(${XPACKAGE_ROOT}/${package} )
	else()		
		add_subdirectory(${XPACKAGE_ROOT}/${package} ${CMAKE_BINARY_DIR}/${target}_deps/${package})
	endif()	
	...
	include(${CMAKE_BINARY_DIR}/Find${package}.cmake)
endmacro()
